...
AGSWeapon::AGSWeapon()
{
	...
	WeaponEdgeCollision = CreateDefaultSubobject<UCapsuleComponent>(TEXT("WeaponEdgeCollision"));
	WeaponEdgeCollision->SetupAttachment(WeaponMesh3P);
	WeaponAbilitySystemComponent= CreateDefaultSubobject<UGSAbilitySystemComponent>(TEXT("WeaponAbilitySystemComponent"));
}
...
void AGSWeapon::Equip()
{
	...
	FName AttachPoint = WeaponAttachPoint;
...
void AGSWeapon::AddAbilities()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("AGSWeapon::AddAbilities:%s"), *Ability->GetName());
...
void AGSWeapon::RemoveAbilities()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("AGSWeapon::RemoveAbilities"));
...
EWeaponEquipSlot AGSWeapon::GetWeaponEquipSlot()
{
	return WeaponEquipSlot;
}
void AGSWeapon::OnWeaponEdgeOverlap(FHitResult Res)
{
	OnWeaponEdgeOverlapDelegate.Broadcast(Res);
}
