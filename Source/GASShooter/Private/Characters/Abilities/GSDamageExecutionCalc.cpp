...
void UGSDamageExecutionCalc::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT(" UGSDamageExecutionCalc::Execute, Hit Bone:%s"), *Hit->BoneName.ToString());
	...
	if (Hit)
	{
		...
		UE_LOG(LogTemp, Warning, TEXT(" UGSDamageExecutionCalc::Execute, Hit->BoneName:%s"),*Hit->BoneName.ToString());
	}
	if(!Hit)
	{
		UE_LOG(LogTemp, Warning, TEXT(" UGSDamageExecutionCalc::Execute, no hit res"));
	}
	if (!AssetTags.HasTagExact(FGameplayTag::RequestGameplayTag(FName("Effect.Damage.CanHeadShot"))))
	{
		UE_LOG(LogTemp, Warning, TEXT(" UGSDamageExecutionCalc::Execute, no headshot tag"));
	}
