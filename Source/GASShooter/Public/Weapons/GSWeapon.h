...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnWeaponEdgeOverlap,FHitResult,Res);
...
public:	
	...
	FName WeaponAttachPoint = "WeaponPoint";
	UPROPERTY(EditDefaultsOnly)
	UDataTable* WeaponHitTable = nullptr;
	UPROPERTY(BlueprintReadWrite)
	bool bActivateOverlap = false;
	UPROPERTY(BlueprintReadOnly, EditDefaultsOnly, Category = "GASShooter|GSWeapon")
	FGameplayTagContainer RestrictedPickupTags;
	

	EWeaponEquipSlot GetWeaponEquipSlot();
	...
	void OnWeaponEdgeOverlap(FHitResult Res);
	...
	UFUNCTION(BlueprintCallable, Category = "GASShooter")
	...
	class UAnimSequence* BlockingAnim = nullptr;
protected:
	UPROPERTY()
	UGSAbilitySystemComponent* AbilitySystemComponent;
	UPROPERTY(BlueprintReadOnly)
	UGSAbilitySystemComponent* WeaponAbilitySystemComponent;
	...
	UPROPERTY(VisibleAnywhere)
	class UCapsuleComponent* WeaponEdgeCollision;

	UPROPERTY(BlueprintAssignable,EditAnywhere)
	FOnWeaponEdgeOverlap OnWeaponEdgeOverlapDelegate;
	...
	UPROPERTY(EditDefaultsOnly, Category = "GASShooter|GSWeapon")
	EWeaponEquipSlot WeaponEquipSlot = EWeaponEquipSlot::EWES_Mainhand;
