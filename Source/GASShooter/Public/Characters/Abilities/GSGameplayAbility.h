...
public:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Ability")
	TArray<EGSAbilityInputID> AbilityInputIDCollection;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Ability")
	bool bAbleToBeParried = true;
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Ability")
	bool bAbleToBeBlocked = false;
	...
	void OnLevelChange(int32 NewLevel,int32 OldLevel);
protected:
	...
	* @param OverrideBlendOutTime If >= 0, will override the BlendOutTime parameter on the AnimMontage instance
	...
	void OnNextComboAvailable();

public:
	UPROPERTY(BlueprintAssignable)
	FOnAbilityEnded OnAbilityEndedDelegate;
	UPROPERTY(BlueprintAssignable,BlueprintReadWrite)
	FOnNextComboAvailable OnNextComboDelegate;
	UPROPERTY(EditDefaultsOnly)
	bool bRequireSpecificMovement = false;
	UPROPERTY(EditDefaultsOnly)
	TEnumAsByte<EMovementMode> RequiredMovementMode;
	UPROPERTY(BlueprintAssignable)
	FOnAbilityLevelChange OnAbilityLevelChangeDelegate;
	//called by AI to execute next combo by code
