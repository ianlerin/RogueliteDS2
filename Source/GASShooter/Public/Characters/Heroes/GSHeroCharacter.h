 ...
 */
UCLASS()
class GASSHOOTER_API AGSHeroCharacter : public AGSCharacterBase, public IGSInteractable, public IGenericTeamAgentInterface
{
	GENERATED_BODY()
...
public:
	...
	UInputHandlerComponent* GetInputHandlerComp()
	{
		return InputHandler;
	}
	/**
...
protected:
	...
	class UInputHandlerComponent* InputHandler = nullptr;
	...
	UFUNCTION(BlueprintCallable)
	void LaunchCharacterWithDirection(EDirection Direction, float Momentum);
	...
	UFUNCTION(BlueprintCallable)
	class UBlendSpace* GetIdleWalkRunTouse();
	UFUNCTION(BlueprintCallable)
	class UAimOffsetBlendSpace1D* GetAimOffsetToUse();
